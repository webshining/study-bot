...
class UserMiddleware(BaseMiddleware):
    async def __call__(
        ...
        user_group_id = get_or_create_chat(message.from_user.id).group_id
        chat_group_id = get_or_create_chat(chat_id).group_id
        data['group_id'] = user_group_id or chat_group_id
